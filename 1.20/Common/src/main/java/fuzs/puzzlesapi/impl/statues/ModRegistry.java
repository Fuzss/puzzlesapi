...
public class ModRegistry {
    static final RegistryManager REGISTRY = RegistryManager.instant(Statues.MOD_ID);
    public static final RegistryReference<MenuType<ArmorStandMenu>> ARMOR_STAND_MENU_TYPE = REGISTRY.registerExtendedMenuType("armor_stand", () -> (containerId, inventory, data) -> {
        return ArmorStandMenu.create(ModRegistry.ARMOR_STAND_MENU_TYPE.get(), containerId, inventory, data, null);
    });
