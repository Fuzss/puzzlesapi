...
import fuzs.puzzlesapi.api.client.statues.v1.gui.components.NewTextureButton;
import fuzs.puzzlesapi.api.client.statues.v1.gui.components.NewTextureSliderButton;
...
public class ArmorStandPositionScreen extends ArmorStandButtonsScreen {
    public static final String ROTATION_TRANSLATION_KEY = Statues.MOD_ID + ".screen.position.rotation";
    public static final String POSITION_X_TRANSLATION_KEY = Statues.MOD_ID + ".screen.position.x";
    public static final String POSITION_Y_TRANSLATION_KEY = Statues.MOD_ID + ".screen.position.y";
    public static final String POSITION_Z_TRANSLATION_KEY = Statues.MOD_ID + ".screen.position.z";
    public static final String INCREMENT_TRANSLATION_KEY = Statues.MOD_ID + ".screen.position.increment";
    public static final String DECREMENT_TRANSLATION_KEY = Statues.MOD_ID + ".screen.position.decrement";
    public static final String PIXELS_TRANSLATION_KEY = Statues.MOD_ID + ".screen.position.pixels";
    public static final String BLOCKS_TRANSLATION_KEY = Statues.MOD_ID + ".screen.position.blocks";
    public static final String DEGREES_TRANSLATION_KEY = Statues.MOD_ID + ".screen.position.degrees";
    public static final String MOVE_BY_TRANSLATION_KEY = Statues.MOD_ID + ".screen.position.moveBy";
    ...
    public static final String ALIGNED_TRANSLATION_KEY = Statues.MOD_ID + ".screen.aligned";
    ...
    private class PositionIncrementWidget extends AbstractArmorStandWidget {
        ...
        public void init(int posX, int posY) {
            ...
            for (int i = 0; i < INCREMENTS.length; i++) {
                ...
                Util.make(ArmorStandPositionScreen.this.addRenderableWidget(new NewTextureButton(posX + 76 + i * 24 + (i > 1 ? 1 : 0), posY + 1, 20, 20, 0, 184, getArmorStandWidgetsLocation(), Component.literal(String.valueOf(getBlockPixelIncrement(increment))), button -> {
                    ...
                    widget.setTooltip(ScreenTooltipFactory.create(ArmorStandPositionScreen.this.font, lines));
    ...
    private class PositionComponentWidget extends AbstractArmorStandWidget {
        ...
        public void init(int posX, int posY) {
            ...
            this.children.add(ArmorStandPositionScreen.this.addRenderableWidget(new ImageButton(posX + 149, posY + 1, 20, 10, 196, 64, 20, getArmorStandWidgetsLocation(), 256, 256, button -> {
                ...
                @Override
                public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTick) {
                    this.setTooltip(Tooltip.create(Component.translatable(INCREMENT_TRANSLATION_KEY, getPixelIncrementComponent(currentIncrement))));
                    super.render(guiGraphics, mouseX, mouseY, partialTick);
                }
            }));
            this.children.add(ArmorStandPositionScreen.this.addRenderableWidget(new ImageButton(posX + 149, posY + 11, 20, 10, 216, 74, 20, getArmorStandWidgetsLocation(), 256, 256, button -> {
                ...
                @Override
                public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTick) {
                    this.setTooltip(Tooltip.create(Component.translatable(DECREMENT_TRANSLATION_KEY, getPixelIncrementComponent(currentIncrement))));
                    super.render(guiGraphics, mouseX, mouseY, partialTick);
                }
            }));
            this.children.add(ArmorStandPositionScreen.this.addRenderableWidget(new ImageButton(posX + 174, posY + 1, 20, 20, 236, 64, getArmorStandWidgetsLocation(), button -> {
