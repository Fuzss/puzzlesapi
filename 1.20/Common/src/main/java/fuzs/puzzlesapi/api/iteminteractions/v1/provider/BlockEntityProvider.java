...
public class BlockEntityProvider extends SimpleItemProvider {
    ...
    public BlockEntityProvider(BlockEntityType<?> blockEntityType, int inventoryWidth, int inventoryHeight) {
        this(BuiltInRegistries.BLOCK_ENTITY_TYPE.getKey(blockEntityType), inventoryWidth, inventoryHeight);
    }
    ...
    public BlockEntityType<?> getBlockEntityType() {
        if (this.blockEntityType == null) {
            if (BuiltInRegistries.BLOCK_ENTITY_TYPE.containsKey(this.blockEntityTypeId)) {
                this.blockEntityType = BuiltInRegistries.BLOCK_ENTITY_TYPE.get(this.blockEntityTypeId);
            } else {
