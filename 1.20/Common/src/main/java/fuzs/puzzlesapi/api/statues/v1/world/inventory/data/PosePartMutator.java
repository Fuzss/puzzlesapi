...
public final class PosePartMutator {
    ...
    public static final String AXIS_X_TRANSLATION_KEY = Statues.MOD_ID + ".screen.rotations.x";
    public static final String AXIS_Y_TRANSLATION_KEY = Statues.MOD_ID + ".screen.rotations.y";
    public static final String AXIS_Z_TRANSLATION_KEY = Statues.MOD_ID + ".screen.rotations.z";
    ...
    public String getTranslationKey() {
        return Statues.MOD_ID + ".screen.rotations.pose." + this.name;
    }
