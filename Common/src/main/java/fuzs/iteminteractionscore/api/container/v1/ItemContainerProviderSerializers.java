...
import fuzs.iteminteractionscore.api.container.v1.provider.*;
...
public class ItemContainerProviderSerializers {
    ...
    static {
        register(BlockEntityProvider.class, ItemInteractionsCore.id("block_entity"), ItemContainerProviderBuilder.fromJson(ItemContainerProviderBuilder::toBlockEntityProvider));
        register(BlockEntityViewProvider.class, ItemInteractionsCore.id("block_entity_view"), ItemContainerProviderBuilder.fromJson(ItemContainerProviderBuilder::toBlockEntityViewProvider));
        register(BundleProvider.class, ItemInteractionsCore.id("bundle"), ItemContainerProviderBuilder.fromJson(ItemContainerProviderBuilder::toBundleProvider));
        register(SimpleItemProvider.class, ItemInteractionsCore.id("item"), ItemContainerProviderBuilder.fromJson(ItemContainerProviderBuilder::toSimpleItemContainerProvider));
        register(EnderChestProvider.class, ItemInteractionsCore.id("ender_chest"), ItemContainerProviderBuilder.fromJson(ItemContainerProviderBuilder::toEnderChestProvider));
    }
